...
const Home = () => {
    ...
    return (
        ...
        <div className="h-screen" style={{ backgroundColor: "#FEDA93", height: "750px", paddingBottom: "50px", position: "relative" }}>
            <header style={{ backgroundColor: "white", padding: "10px 0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                    {/* Logo en la esquina superior izquierda */}
                    <img src="https://imgur.com/UTZGzes.png" alt="Logo" style={{ height: "40px", width: "80px", marginLeft: "20px"}} />
                </div>
                <nav>
            ...
            <div className="flex flex-col w-auto h-auto" style={{ backgroundColor: "#5D9E7E" }}>
                <div className="flex flex-col py-20 place-items-center justify-center">
                    <h1 className="text-5xl font-bold pb-10 text-white">
                        Are you ready to make crypto money for free?
                    </h1>
                    ...
                    <button
                        type="submit"
                        className="inline-flex h-8 w-52 justify-center"
                        style={{
                        backgroundColor: "#3C6651",
                        fontWeight: "bold",
                        color: "white",
                        borderRadius: "8px", // Un valor grande para redondear completamente las esquinas
                    }}
                    onClick={() => {
    ...
    >
        Conecta tu wallet 👻
            ...
            <div class="container">
    <img src="https://imgur.com/0u7PNgJ.png" alt="Descripción de la imagen" style={{float: "left",height:"300px",width:"auto",marginLeft:"20px",marginRight:"20px"}}></img>
    <p style={{color: "black", fontSize: "23px",marginTop:"20px",fontFamily: "arial",marginRight:"20px",textAlign:"justify"}}><br/>Descarga nuestra extensión para Google Chrome que busca automáticamente cupones de descuento cuando compras en línea. Pero en lugar de ahorrarte dinero, te recompensa con criptomoneda por cada compra que haces. ¡Compra y gana mientras ahorras!</p>
